...
//             and high-performance web applications. Proficient in MERN stack,
//             NestJS, and PostgreSQL, with expertise in RESTful APIs, database
//             optimization, and modern web architecture. Known for clean,
//             maintainable code, rapid learning, and strong collaboration in
    ...
    <section id="about" className="section">
      <div className="max-w-5xl mx-auto flex flex-col items-center text-center space-y-8">
        ...
        <p className="text-gray-400 text-xl max-w-3xl">
          Full-Stack Developer with years of experience building scalable and
          high-performance web applications. Proficient in MERN stack, NestJS,
          and PostgreSQL, with expertise in RESTful APIs, database optimization,
          and modern web architecture. Known for clean, maintainable code, rapid
          learning, and strong collaboration in fast-paced environments.
        </p>
